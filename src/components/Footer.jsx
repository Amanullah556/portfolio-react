  ...
  return (
    <footer className="relative bg-slate-900 border-t border-slate-800">
      ...
      <motion.div
        ...
        className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 pb-8 sm:pb-10 text-center"
      >
        {/* Name */}
        ...
        <div className="flex justify-center gap-4 sm:gap-5 mt-5 sm:mt-6">
          {socials.map((s) => (
            <motion.a
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white text-base sm:text-lg"
            >
              {s.icon}
            </motion.a>
          ))}
