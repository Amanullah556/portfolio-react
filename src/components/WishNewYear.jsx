  ...
  return (
    <div className="relative z-[100]">
      {!isWished ? (
        ...
        >
          <h4 className="text-blue-400 text-sm font-bold mb-4 uppercase tracking-widest">Celebrate with Aman</h4>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 text-lg md:text-xl max-w-lg mx-auto">
                Aman Ullah wishes you a year full of code, creativity, and success! 🚀
              </p>
